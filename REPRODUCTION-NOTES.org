...
- Adds Claude command definitions
- Sets up change-requests/, experiments/, research/ workflows

* Phase 4: NODE-SETUP.org Development Environment
**Status**: ⏳ Pending
**Expected**:
- Creates package.json with Shadow-CLJS dependencies
- Creates shadow-cljs.edn configuration
- Implements initial ClojureScript REPL in src/gemini_repl/core.cljs
